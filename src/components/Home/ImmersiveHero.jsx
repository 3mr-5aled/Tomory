      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-4rem)] max-w-screen-xl flex-col gap-12 px-6 py-20 lg:flex-row lg:items-center">
        ...
        <div className="relative flex-1">
          ...
          <div className="relative mx-auto max-w-sm">
            <div className="absolute -top-6 left-6 rounded-full bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-amber-900 shadow-lg">
              Harvest 2026
            </div>
            <img
              src={datesPlate}
            ...
            />
            <div className="absolute -bottom-8 right-0 rounded-3xl bg-amber-800/90 px-6 py-4 text-sm text-amber-50 shadow-xl">
