...
const ProductsList = ({ variant }) => {
  ...
  return (
    <section
      className="relative min-h-[calc(100dvh-5rem)] overflow-hidden bg-[#f7f1e8] pb-20 font-body dark:bg-slate-900"
    >
      {/* Background Elements */}
      ...
      <div className="relative mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
        <header className="mb-12 text-center md:text-left">
          <h2 className="font-display text-4xl font-bold tracking-tight text-amber-950 dark:text-amber-50 md:text-6xl">
            Our Collection
          </h2>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-amber-900/70 dark:text-slate-300">
            ...
            our dates are a superfood that can improve digestion and boost overall health.
          </p>
        </header>
        ...
        {products && products.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="group relative h-full rounded-[2rem] border border-amber-200/50 bg-white/80 p-3 shadow-xl shadow-amber-200/20 backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-amber-300/40 dark:border-slate-700/50 dark:bg-slate-800/80 dark:shadow-none">
                      ...
                      >
                        <div className="relative aspect-square overflow-hidden rounded-[1.5rem] bg-amber-50/50 p-6 dark:bg-slate-700/30">
                          <img
                        ...
                        <div className="mt-6 px-3 pb-4">
                          <div className="flex items-start justify-between gap-2">
                            <h3 className="font-display text-2xl font-bold text-amber-950 dark:text-amber-50">
                              {product.name}
                            </h3>
          ...
          <div className="mt-20 text-center">
            <h2 className="font-display text-3xl text-amber-950 dark:text-amber-50">
              No products found
            </h2>
