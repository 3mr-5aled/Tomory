          ...
          <li>
            <a href="#" className="group block overflow-hidden">
              <img
                ...
                alt=""
                className="h-[350px] w-full object-cover transition duration-500 rounded-t-xl group-hover:scale-105 sm:h-[450px]"
              />

              <div className="relative bg-white dark:bg-slate-900 rounded-b-xl px-3 pt-3 pb-2">
                <h3 className="text-xs text-gray-700 dark:text-white group-hover:underline group-hover:underline-offset-4">
                  Basic Tee
                </h3>
